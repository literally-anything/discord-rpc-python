...
class Payload:
    ...
    def __init__(self, data, clear_none=True) -> None:
        if clear_none:
    ...
    @classmethod
    def subscribe(cls, event: str, args=None) -> 'Payload':
        if args is None:
            args = {}
        payload = {
            "cmd": "SUBSCRIBE",
    ...
    @classmethod
    def unsubscribe(cls, event: str, args=None) -> 'Payload':
        if args is None:
            args = {}
        payload = {
            "cmd": "UNSUBSCRIBE",
    ...
    def set_voice_settings(cls, _input: dict = None, output: dict = None,
                           ...
                           deaf: bool = None, mute: bool = None) -> 'Payload':
        payload = {
