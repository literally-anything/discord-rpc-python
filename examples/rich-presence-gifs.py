...
RPC.update(state="Custom gifs",details="Using discord_rpc",large_image=("https://media.tenor.com/9c83g4VPctQAAAAi/shaking-eyes-eyes-shaking.gif"), large_text="Watching!",
